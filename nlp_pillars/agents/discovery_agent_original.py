...
class DiscoveryAgent:
    ...
    def run(cls, input_data: DiscoveryInput) -> DiscoveryOutput:
        """Static method wrapper for compatibility with orchestrator.
        
        Args:
            input_data: DiscoveryInput with pillar config and context
            
        Returns:
            DiscoveryOutput with search queries and rationale
        """
        # Create a temporary instance and run
        agent = cls()
